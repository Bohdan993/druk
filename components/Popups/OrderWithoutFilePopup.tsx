        ...
        <form onSubmit={handleSubmit(onSubmit)} className="pt-[38px]">
            ...
            <div className="pb-[25px] relative">
                <div>
                    ...
                    <input className="input font-[600] leading-[1.2] py-[11.5px] px-[15px] text-black border-natural-green border-[1px] rounded-[15px] outline-none text-[14px] w-full max-w-[173px]" type="text" placeholder="Введіть ваше ім'я" id={`${props?.id}-name`} {...register("name")} />
                </div>
